...
import com.atguigu.gmall0105.realtime.bean.dim.SkuInfo
...
object SkuInfoApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    skuInfoDstream.foreachRDD{rdd=>
      ...
      rdd.saveToPhoenix("GMALL0105_SKU_INFO",Seq("ID", "SPU_ID","PRICE","SKU_NAME","TM_ID","CATEGORY3_ID","CREATE_TIME","CATEGORY3_NAME","SPU_NAME","TM_NAME"  )
